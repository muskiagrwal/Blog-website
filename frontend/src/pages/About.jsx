  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications,Muskan excels in
      ...
      <br />
      <span>
        Muskan is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond her professional achievements, Muskan is a big fan of cricket and
        ...
        significantly shaped Muskan’s journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating Muskan to
